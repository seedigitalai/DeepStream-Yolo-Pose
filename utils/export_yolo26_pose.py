...
def yolo26_pose_export(weights, device, fuse=True):
    model = YOLO(weights)
...
def main(args):
    ...
    print("Opening YOLO26-Pose model")

    device = torch.device("cpu")
    model = yolo26_pose_export(args.weights, device)
...
def parse_args():
    import argparse
    parser = argparse.ArgumentParser(description="DeepStream YOLO26-Pose conversion")
